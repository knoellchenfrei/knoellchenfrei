...
describe('representativePoint liegt in seiner eigenen Fläche', () => {
  ...
  it('findet die Daten aller acht Städte', () => {
    ...
    // Am 16. September 746 (Berlin 103, Düsseldorf 44, Frankfurt 27, Hamburg 145,
    // Innsbruck 21, Karlsruhe 279, Köln 45, München 82).
    expect(summe).toBeGreaterThanOrEqual(700)
  })
