...
describe('representativePoint liegt in seiner eigenen Fläche', () => {
  ...
  it('findet die Daten aller acht Städte', () => {
    expect(STAEDTE).toEqual(['berlin', 'cottbus', 'duesseldorf', 'frankfurt', 'hamburg', 'karlsruhe', 'koeln', 'muenchen'])
    ...
    // Karlsruhe 279, Köln 45, München 82); seit dem 16. September dazu Cottbus 5.
