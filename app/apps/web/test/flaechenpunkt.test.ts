...
describe('representativePoint liegt in seiner eigenen Fläche', () => {
  ...
  it('findet die Daten aller acht Städte', () => {
    expect(STAEDTE).toEqual(['berlin', 'duesseldorf', 'frankfurt', 'hamburg', 'karlsruhe', 'koeln', 'muenchen', 'salzburg'])
    ...
    // Karlsruhe 279, Köln 45, München 82); am 16. September 765 mit Salzburgs 40.
    expect(summe).toBeGreaterThanOrEqual(720)
  })
