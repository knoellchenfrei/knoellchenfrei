...
pnpm test                                           # 763 Unit-Tests (core, api, web)
...
`apps/web` (104, Beta-Riegel, Zähler, Besuchszähler, Flächenkennung, Namen,
Formatierung, Speicher, Datenquelle, Flächenpunkt, Aktualisieren, Demodaten) und `packages/ingest` (11, die zwei Wächter des
...
cd ../../packages/ingest
TEST_COUNT=763 E2E_COUNT=154 npx tsx src/build-badges.ts
