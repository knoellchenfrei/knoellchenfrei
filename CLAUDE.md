...
pnpm test                                           # 578 Unit-Tests (core, api, web)
...
davon Tests: `core` (528), `apps/api` (35, Worker und Zählwerk) und `apps/web` (15, der
...
cd ../../packages/ingest
TEST_COUNT=578 E2E_COUNT=152 npx tsx src/build-badges.ts
