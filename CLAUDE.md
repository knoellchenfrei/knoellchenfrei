...
pnpm test                                           # 842 Unit-Tests (core, api, web)
...
`apps/web` (183, Beta-Riegel, Zähler, Besuchszähler, Flächenkennung, Namen,
...
cd ../../packages/ingest
TEST_COUNT=842 E2E_COUNT=170 npx tsx src/build-badges.ts
