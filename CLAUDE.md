...
pnpm test                                           # 800 Unit-Tests (core, api, web)
...
`apps/web` (141, Beta-Riegel, Zähler, Besuchszähler, Flächenkennung, Namen,
...
cd ../../packages/ingest
TEST_COUNT=800 E2E_COUNT=170 npx tsx src/build-badges.ts
