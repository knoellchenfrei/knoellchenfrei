...
pnpm test                                           # 538 Unit-Tests (core, api, web)
...
davon Tests: `core` (508), `apps/api` (15, der Worker) und `apps/web` (15, der
...
cd ../../packages/ingest
TEST_COUNT=538 E2E_COUNT=138 npx tsx src/build-badges.ts
