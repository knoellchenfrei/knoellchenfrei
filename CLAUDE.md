...
pnpm test                                           # 629 Unit-Tests (core, api, web)
...
davon Tests: `core` (541), `apps/api` (60, Worker und Zählwerk) und `apps/web`
(28, Beta-Riegel und der Zähler in der App). Die beiden letzten haben eine
...
cd ../../packages/ingest
TEST_COUNT=629 E2E_COUNT=152 npx tsx src/build-badges.ts
