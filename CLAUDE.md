...
pnpm test                                           # 873 Unit-Tests (core, api, web)
...
`apps/web` (214, Beta-Riegel, Zähler, Besuchszähler, Flächenkennung, Namen,
...
cd ../../packages/ingest
TEST_COUNT=873 E2E_COUNT=174 npx tsx src/build-badges.ts
