...
pnpm test                                           # 655 Unit-Tests (core, api, web)
...
davon Tests: `core` (548), `apps/api` (65, Worker und Zählwerk) und `apps/web`
...
cd ../../packages/ingest
TEST_COUNT=655 E2E_COUNT=154 npx tsx src/build-badges.ts
