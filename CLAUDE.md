...
pnpm test                                           # 663 Unit-Tests (core, api, web)
...
davon Tests: `core` (548), `apps/api` (73, Worker und Zählwerk) und `apps/web`
...
cd ../../packages/ingest
TEST_COUNT=663 E2E_COUNT=154 npx tsx src/build-badges.ts
