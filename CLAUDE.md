...
pnpm test                                           # 541 Unit-Tests (core, api, web)
...
davon Tests: `core` (511), `apps/api` (15, der Worker) und `apps/web` (15, der
...
cd ../../packages/ingest
TEST_COUNT=541 E2E_COUNT=140 npx tsx src/build-badges.ts
