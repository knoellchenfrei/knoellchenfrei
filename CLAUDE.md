...
pnpm test                                           # 862 Unit-Tests (core, api, web)
...
`apps/web` (203, Beta-Riegel, Zähler, Besuchszähler, Flächenkennung, Namen,
...
cd ../../packages/ingest
TEST_COUNT=862 E2E_COUNT=174 npx tsx src/build-badges.ts
