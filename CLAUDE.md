...
pnpm test                                           # 575 Unit-Tests (core, api, web)
...
davon Tests: `core` (528), `apps/api` (32, Worker und Zaehlwerk) und `apps/web` (15, der
...
cd ../../packages/ingest
TEST_COUNT=575 E2E_COUNT=146 npx tsx src/build-badges.ts
