...
16. September die Städte der zweiten Runde, seit dem 17. Essen als erste Stadt,
die nur Zonengrenzen veröffentlicht („Zeiten unbekannt"); die vollständige Liste
mit je einem Bericht `docs/staedte-<stadt>.md` steht in `docs/staedte.md`.
