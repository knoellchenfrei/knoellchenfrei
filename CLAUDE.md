...
pnpm test                                           # 849 Unit-Tests (core, api, web)
...
`apps/web` (190, Beta-Riegel, Zähler, Besuchszähler, Flächenkennung, Namen,
...
cd ../../packages/ingest
TEST_COUNT=849 E2E_COUNT=174 npx tsx src/build-badges.ts
