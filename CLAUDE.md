...
pnpm test                                           # 580 Unit-Tests (core, api, web)
...
davon Tests: `core` (528), `apps/api` (37, Worker und Zählwerk) und `apps/web` (15, der
...
cd ../../packages/ingest
TEST_COUNT=580 E2E_COUNT=152 npx tsx src/build-badges.ts
