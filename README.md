...
| | |
| --- | --- |
| Unit-Tests | 888 — 570 in `core`, 86 für Worker und Zählwerk, 221 für die Web-App, 11 für den Artifact-Bau. Ein grosser Teil davon sind Regressionstests für konkrete gefundene Fehler; die 70 Regeln in `CLAUDE.md` sind die nachzählbare Seite davon |
