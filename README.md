...
| | |
| --- | --- |
| Unit-Tests | 877 — 570 in `core`, 82 für Worker und Zählwerk, 214 für die Web-App, 11 für den Artifact-Bau. Ein grosser Teil davon sind Regressionstests für konkrete gefundene Fehler; die 70 Regeln in `CLAUDE.md` sind die nachzählbare Seite davon |
| End-to-End | 174 über Desktop und Handy, gegen den Produktions-Build; 168 bestehen, sechs überspringen sich selbst — einer, wenn der Tag nichts zu erklären hat, fünf auf dem Gerät, für das sie nicht gedacht sind |
