...
cd apps/web && npx playwright test     # 214 End-to-End-Tests
```
...
| End-to-End | 214 über Desktop und Handy, gegen den Produktions-Build; 202 bestehen, zwölf überspringen sich selbst — einer, wenn der Tag nichts zu erklären hat, elf auf dem Gerät, für das sie nicht gedacht sind |
