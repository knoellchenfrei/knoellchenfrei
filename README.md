...
| | |
| --- | --- |
| Unit-Tests | 798 — 570 in `core`, 82 für Worker und Zählwerk, 135 für die Web-App, 11 für den Artifact-Bau. Ein grosser Teil davon sind Regressionstests für konkrete gefundene Fehler; die 70 Regeln in `CLAUDE.md` sind die nachzählbare Seite davon |
