...
| | |
| --- | --- |
| Unit-Tests | 763 — 570 in `core`, 78 für Worker und Zählwerk, 104 für die Web-App, 11 für den Artifact-Bau. Ein grosser Teil davon sind Regressionstests für konkrete gefundene Fehler; die 68 Regeln in `CLAUDE.md` sind die nachzählbare Seite davon |
