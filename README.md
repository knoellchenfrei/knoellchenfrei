...
cd apps/web && npx playwright test     # 202 End-to-End-Tests
```
...
| End-to-End | 202 über Desktop und Handy, gegen den Produktions-Build; 191 bestehen, elf überspringen sich selbst — einer, wenn der Tag nichts zu erklären hat, zehn auf dem Gerät, für das sie nicht gedacht sind |
