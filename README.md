...
| | |
| --- | --- |
| Unit-Tests | 1084 — 769 in `core`, 86 für Worker und Zählwerk, 218 für die Web-App, 11 für den Artifact-Bau. Ein grosser Teil davon sind Regressionstests für konkrete gefundene Fehler; die 71 Regeln in `CLAUDE.md` sind die nachzählbare Seite davon |
| End-to-End | 180 über Desktop und Handy, gegen den Produktions-Build; 172 bestehen, acht überspringen sich selbst — einer, wenn der Tag nichts zu erklären hat, sieben auf dem Gerät, für das sie nicht gedacht sind |
