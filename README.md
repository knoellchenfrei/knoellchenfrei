...
| | |
| --- | --- |
| Unit-Tests | 1085 — 770 in `core`, 86 für Worker und Zählwerk, 218 für die Web-App, 11 für den Artifact-Bau. Ein grosser Teil davon sind Regressionstests für konkrete gefundene Fehler; die 71 Regeln in `CLAUDE.md` sind die nachzählbare Seite davon |
